# tsnmp v0.1.0a0 Alpha Release Notes
...
`tsnmp` v0.1.0a0 is the first alpha cut of the `trishul-snmp` runtime.
...
The alpha is intentionally package-first. The CLI is present, but secondary.
...
- no sync facade is included in this alpha

## Validation Used for This Alpha
